...
async def hmm(yes):
    ...
    pm_caption += f"{luciferemoji} **𝙎𝙐𝙋𝙋𝙊𝙍𝙏 𝘾𝙃𝘼𝙉𝙉𝙀𝙇** ☞ [ᴊᴏɪɴ](https://t.me/dominator_bot_official)\n"
    pm_caption += f"{luciferemoji} **𝙇𝙄𝘾𝙀𝙉𝙎𝙀**  ☞ [TEAM LUCIFER 𝚄𝙱](https://github.com/DOMINATOR-XD/Lucifer-X/blob/main/LICENSE)\n"
